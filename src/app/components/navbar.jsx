...
export default function Navbar() {
  ...
  return (
    <nav className="w-full py-4 sticky shadow-md bg-white text-black dark:bg-black dark:text-white top-0 z-50 border-b">
      {/* NAV CONTAINER */}
      <div className="max-w-8xl px-6 md:px-10 lg:px-20 space-x-20  flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-20">
          ...
          <Button
            className="px-8 py-3"
            href="https://calendly.com/akoredephebe2"
          >
            Book a Call
          </Button>
        </div>
      ...
      {open && (
        <div className="md:hidden px-6 py-6  flex flex-col gap-6 md:text-md lg:text-md text-sm ">
          <Link href="#">
            <span className="text-lg hover:text-purple" onClick={closeNav}>
              Home
            </span>
          </Link>
          <Link href="#">
