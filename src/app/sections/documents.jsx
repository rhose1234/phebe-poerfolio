        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
          {documents.slice(0, 3).map((doc, index) => (
            <a
              ...
              className="flex items-center gap-3 justify-center text-purple px-6 py-4 border border-purple rounded-xl shadow-md hover:bg-purple hover:text-white transition-all duration-300 text-center"
            >
              <AiOutlineFileText className="text-2xl" />
              <span className="font-medium text-md">{doc.name}</span>
            </a>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full">
          {documents.slice(3).map((doc, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 justify-center text-purple px-4 py-4 border border-purple rounded-xl shadow-md hover:bg-purple hover:text-white transition-all duration-300 text-center"
            >
              <AiOutlineFileText className="text-2xl" />
              <span className="font-medium text-md">{doc.name}</span>
            </a>
