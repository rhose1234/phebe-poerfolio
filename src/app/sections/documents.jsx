...
export default function Documents() {
  ...
  return (
    <div className="px-10 md:px-20 lg:px-20 bg-white dark:bg-foreground py-10 md:py-20 lg:py-20">
     <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-center mb-16 text-foreground dark:text-white">
